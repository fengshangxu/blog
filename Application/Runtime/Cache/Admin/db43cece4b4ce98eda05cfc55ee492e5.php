...
<span class="action-span1"><a href="#">冯上旭的个人blog</a> </span><span id="search_id" class="action-span1"> - 文章列表 </span>
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
   <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
	    ...
	    <td><span ><?php echo ($v["category_id"]); ?></span></td>
	    <td align="right"><span ><?php echo ($v["author"]); ?></span></td>
	    <td align="center"><img height="30" src="/blog/Public/..<?php echo ($v["img"]); ?>"  /></td>
	    <td align="center"><?php echo ($v["create_time"]); ?></td>
	   
	        <td align="center">
	      <a href="<?php echo U('Admin/Article/info',array('id'=>$v['id']));?>" target="main-frame" title="查看"><img src="/blog/Public/admin/images/icon_view.gif" width="16" height="16" border="0" /></a>
...
<!--<script src="/blog/Public/common/alert.js"></script>-->
<script>
	$('.ajax').click(function(){
		var $this = $(this);
		...
		$.ajax({
			type:"get",
			url:'<?php echo U("Admin/Article/delete");?>?id='+id,
