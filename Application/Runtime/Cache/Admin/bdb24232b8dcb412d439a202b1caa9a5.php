...
<div id="header-div">
  ...
  <div id="logo-div" style="bgcolor:#000000;"><img src="/blog/Public/admin/images/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" /></div>
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
        ...
        <div id="load-div" style="padding: 5px 10px 0 0; text-align: right; color: #FF9900; display: none;width:40%;float:right;"><img src="/blog/Public/admin/images/top_loader.gif" width="16" height="16" alt="正在处理您的请求..." style="vertical-align: middle" /> 正在处理您的请求...</div>
  </div>
...
<div id="menu-div">
  <ul style='float:right;'>
    ...
    <li><a href="#" target="main-frame">设置导航栏</a></li>
        ...
        <li> <a href="javascript:;" target="main-frame" class="fix-submenu" title='清除缓存' onclick="clear_cache()">清除缓存</a></li>
        <li><a href="<?php echo U('Admin/Login/logout');?>" target="_top" class="fix-submenu">退出</a>s</li>
