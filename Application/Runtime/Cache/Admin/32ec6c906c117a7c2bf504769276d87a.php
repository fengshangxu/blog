...
<div class="box">
	...
	<form action="<?php echo U('Admin/Login/index');?>" method="post">
		<table>
			...
			<tr><td> </td><td ><img src="<?php echo U('Admin/Login/verify');?>" id="verify_img" title="点击刷新验证码" /></td></tr>
...
<script>	
	$('.input').eq(0).blur(function(){
		...
		$.ajax({
			type : 'get',
			url : "<?php echo U('Admin/Login/checkUser','','');?>/username/"+username,
	...
	img.onclick = function(){
		...
		this.setAttribute('src',"<?php echo U('Admin/Login/verify');?>?id="+parseInt(Math.random()*1000));
	}
