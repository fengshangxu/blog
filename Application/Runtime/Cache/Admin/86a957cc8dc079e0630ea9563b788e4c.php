...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form id="form" enctype="multipart/form-data" action="<?php echo U('Admin/Article/articleadd');?>" method="post" name="theForm" >
        <!-- 最大文件限制 -->
        ...
        <table width="90%" id="general-table" align="center">
          <tr>
            ...
            <td><input type="text" name="article_name" value="" style="float:left;color:;" size="30" /></td>
          </tr>
          <tr>
            <td class="label"> 文章作者： </td>
            <td><input type="text" name="article_author" value="" size="20"  />
        </td>
          </tr>
          <tr>
            ...
            <td><select name="category_id"  >
                <option value="0">其他</option>
                         <?php if(is_array($cat)): foreach($cat as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo str_repeat('—',$v['lev']); echo ($v["cate_name"]); ?>
		   ...
		   <tr>
            ...
            <td>
				<textarea name="article_content" id="container" style="width:500px;"></textarea>
				<!-- 配置文件 -->
          ...
          <tr>
            ...
            <td>
                ...
                <?php echo W('Common/UploadImage/render',array(array('type'=>'article','id'=>$id)));?>
            </td>
            <script>
