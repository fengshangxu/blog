...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="<?php echo U('Admin/Article/articleadd');?>" method="post" name="theForm" >
        <!-- 最大文件限制 -->
          ...
          <tr>
            ...
            <td><select name="cat_id"  >
                <option value="0">请选择...</option>
                         <?php if(is_array($cat)): foreach($cat as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo str_repeat('-- ',$v['lev']),$v['name']; ?>
