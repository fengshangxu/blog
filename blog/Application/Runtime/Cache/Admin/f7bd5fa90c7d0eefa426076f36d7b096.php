...
<h1>
<span class="action-span"><a href="<?php echo U('Admin/Cate/catelist');?>">文章分类</a></span>
<span class="action-span1"><a href="#">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加分类 </span>
<div style="clear:both"></div>
</h1>

<div class="main-div">
  <form action="<?php echo U('Admin/Cate/catedit');?>" method="post" name="theForm" enctype="multipart/form-data">
      ...
      <tr>
        ...
        <td>
          <select name="pid">
                        ...
                        <?php if(is_array($cat)): foreach($cat as $key=>$v): ?><foreach name='cat' item='v'>
						<?php if($v['id'] == $row['pid']): ?><option value="<?php echo ($v['id']); ?>" selected>
								<?php echo str_repeat('-- ',$v['lev']),$v['name']; ?>
							</option>
						<?php else: ?> 
