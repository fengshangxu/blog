...
<h1>
<span class="action-span"><a href="<?php echo U('Admin/Photo/albumadd');?>">添加新相册</a></span>
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
   <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
	    ...
	    <td class="first-cell" style=""><span ><a href="<?php echo U('Admin/Photo/photoadd');?>?name=<?php echo ($v["name"]); ?>"><?php echo ($v["name"]); ?></a></span></td>
	    <td><span ><?php echo ($v["number"]); ?></span></td>
	    <td align="center" style="cursor: pointer"><?php echo ($v["is_show"]); ?></td>
...
<script>
	$('.ajax').click(function(){
		...
		$.ajax({
			type:"get",
			url:'<?php echo U("Admin/Photo/albumdel");?>?id='+id,
